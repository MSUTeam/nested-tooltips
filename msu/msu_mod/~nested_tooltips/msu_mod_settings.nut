...
nestedTooltipsPage.addRangeSetting("showDelay", 200, 0, 1000, 5, "Show Time", "The time in milliseconds until the tooltip appears after hovering an element.");
nestedTooltipsPage.addRangeSetting("hideDelay", 100, 0, 1000, 5, "Hide Time", "The time in milliseconds until the tooltip disappears after leaving an element.");
nestedTooltipsPage.addRangeSetting("lockDelay", 1000, 0, 10000, 5, "Lock Time", "The time in milliseconds until the tooltip locks and allows you to enter it with your mouse to access nested tooltips.");
